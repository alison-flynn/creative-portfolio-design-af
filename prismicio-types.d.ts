...
/**
 * Item in *BentoGrid → Default → Primary → Bento Grid Items*
 */
export interface BentoGridSliceDefaultPrimaryBentoGridItemsItem {
  /**
   * Title field in *BentoGrid → Default → Primary → Bento Grid Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento_grid.default.primary.bento_grid_items[].title
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  title: prismic.RichTextField;

  /**
   * Image field in *BentoGrid → Default → Primary → Bento Grid Items*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: bento_grid.default.primary.bento_grid_items[].image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  image: prismic.ImageField<never>;

  /**
   * Figjam field in *BentoGrid → Default → Primary → Bento Grid Items*
   *
   * - **Field Type**: Link
   * - **Placeholder**: *None*
   * - **API ID Path**: bento_grid.default.primary.bento_grid_items[].figjam
   * - **Documentation**: https://prismic.io/docs/field#link-content-relationship
   */
  figjam: prismic.LinkField;

  /**
   * Description field in *BentoGrid → Default → Primary → Bento Grid Items*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: bento_grid.default.primary.bento_grid_items[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
...
export interface BentoGridSliceDefaultPrimary {
  /**
   * Bento Grid Items field in *BentoGrid → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: bento_grid.default.primary.bento_grid_items[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  bento_grid_items: prismic.GroupField<
    Simplify<BentoGridSliceDefaultPrimaryBentoGridItemsItem>
  >;
}
...
/**
 * Item in *Experience → Default → Primary → Exp*
 */
export interface ExperienceSliceDefaultPrimaryExpItem {
  /**
   * Title field in *Experience → Default → Primary → Exp*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp[].title
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  title: prismic.KeyTextField;
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp[].time_period
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  time_period: prismic.KeyTextField;

  /**
   * Institution field in *Experience → Default → Primary → Exp*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp[].institution
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  institution: prismic.KeyTextField;

  /**
   * Description field in *Experience → Default → Primary → Exp*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp[].description
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  description: prismic.RichTextField;
}
...
export interface ExperienceSliceDefaultPrimary {
  ...
  /**
   * Exp field in *Experience → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: experience.default.primary.exp[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  exp: prismic.GroupField<Simplify<ExperienceSliceDefaultPrimaryExpItem>>;
}
...
/**
 * Primary content in *ImageLeftTextRight → Default → Primary*
 */
export interface ImageLeftTextRightSliceDefaultPrimary {
  /**
   * Left Image field in *ImageLeftTextRight → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: image_left_text_right.default.primary.left_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
  left_image: prismic.ImageField<never>;

  /**
   * Right Column field in *ImageLeftTextRight → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: image_left_text_right.default.primary.right_column
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  right_column: prismic.RichTextField;
}
...
export interface TwoColumnLayoutSliceDefaultPrimary {
  /**
   * Left Column field in *TwoColumnLayout → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: two_column_layout.default.primary.left_column
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  left_column: prismic.RichTextField;

  /**
   * Right Column field in *TwoColumnLayout → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: two_column_layout.default.primary.right_column
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  right_column: prismic.RichTextField;

  /**
   * Right Image field in *TwoColumnLayout → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: two_column_layout.default.primary.right_image
   * - **Documentation**: https://prismic.io/docs/field#image
   */
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      AllDocumentTypes,
      BentoGridSlice,
      BentoGridSliceDefaultPrimaryBentoGridItemsItem,
      ...
      ExperienceSlice,
      ExperienceSliceDefaultPrimaryExpItem,
